...
public class JenaDemo4 {
    ...
    public static void main(String[] args) {
        ...
        configuration.addProperty(ReasonerVocabulary.PROPruleSet,  "data/ttl/demo.rules");

        // Create an instance of such a reasoner
        Reasoner reasoner = GenericRuleReasonerFactory.theInstance().create(configuration);

        // Load test data
        Model data = FileManager.get().loadModel("file:data/ttl/demoData.ttl");
